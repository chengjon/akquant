...
| `hilbert` | 3 | HT_DCPERIOD, HT_DCPHASE, HT_PHASOR |
| **`candlestick`** | **60** | **CDLDOJI, CDLHAMMER, CDLHANGINGMAN, CDL_ENGULFING, CDL_HARAMI, CDL_MORNINGSTAR, CDL_EVENINGSTAR, CDL_3BLACKCROWS, CDL_3WHITESOLDIERS, CDL_SHOOTINGSTAR, CDLPIERCING, CDLDARKCLOUDCOVER, CDLHARAMICROSS, CDLMARUBOZU, CDLKICKING, CDLSPINNINGTOP, CDLRISEFALL3METHODS, CDLTHRUSTING, CDLINNECK, CDLONNECK, CDL2CROWS, CDL3INSIDE, CDL3OUTSIDE, CDLBELTHOLD, CDLCLOSINGMARUBOZU, CDLDRAGONFLYDOJI, CDLGRAVESTONEDOJI, CDLLONGLINE, CDLSHORTLINE, CDLSTALLEDPATTERN, CDLTRISTAR, CDL3LINESTRIKE, CDLADVANCEBLOCK, CDLTASUKIGAP, CDLIDENTICAL3CROWS, CDLBREAKAWAY, CDLCONCEALBABYSWALL, CDLMATHOLD, CDLSEPARATINGLINES, CDLXSIDEGAP3METHODS, CDL3STARSINSOUTH, CDLCOUNTERATTACK, CDLGAPSIDESIDEWHITE, CDLHOMINGPIGEON, CDLLADDERBOTTOM, CDLMATCHINGLOW, CDLRICKSHAWMAN, CDLTAKURI, CDLUNIQUE3RIVER, CDLMATCHINGHIGH, CDLABANDONEDBABY, CDLDOJISTAR, CDLEVENINGDOJISTAR, CDLHIGHWAVE, CDLHIKKAKE, CDLINVERTEDHAMMER, CDLKICKINGBYLENGTH, CDLLONGLEGGEDDOJI, CDLMORNINGDOJISTAR, CDLSTICKSANDWICH** |
| **合计** | **178** | |
...
| `talib/_candlestick.py` | K线形态（CDLDOJI, CDLHAMMER, ... 60 个） |
